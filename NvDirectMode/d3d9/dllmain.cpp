...
// ---------------------------------------------------------------------------
// Diagnostic log — writes to nvdirectmode_proxy.log next to the game exe.
// Shared across NvDirectMode d3d9/d3d10/d3d11/opengl32 proxies (only one will
// actually be loaded in any given game), opened in append mode.
// ---------------------------------------------------------------------------
