 ...
 */
template<typename Char>
void ZLOG_API LogMessage(SEVERITY severity, const std::basic_string<Char>& module, std::basic_string<Char> format, ...);
 ...
 */
template<typename Char>
void ZLOG_API LogMessageEx(SEVERITY severity, const std::basic_string<Char>& module, bool addEndl, bool addMarker, std::basic_string<Char> format, ...);
