...
template<typename Char>
void LogMessage(SEVERITY severity, const std::basic_string<Char>& module, std::basic_string<Char> format, ...)
{
	va_list args;
	va_start(args, format);
...
template<typename Char>
void LogMessageEx(SEVERITY severity, const std::basic_string<Char>& module, bool addEndl, bool addMarker, std::basic_string<Char> format, ...)
{
	va_list args;
	va_start(args, format);
...
template void ZLOG_API LogMessage<char>(SEVERITY severity, const std::basic_string<char>& module, std::basic_string<char> format, ...);
template void ZLOG_API LogMessage<wchar_t>(SEVERITY severity, const std::basic_string<wchar_t>& module, std::basic_string<wchar_t> format, ...);
...
template void ZLOG_API LogMessageEx<char>(SEVERITY severity, const std::basic_string<char>& module, bool addEndl, bool addMarker, std::basic_string<char> format, ...);
template void ZLOG_API LogMessageEx<wchar_t>(SEVERITY severity, const std::basic_string<wchar_t>& module, bool addEndl, bool addMarker, std::basic_string<wchar_t> format, ...);
...
BOOST_NORETURN void boost::throw_exception(const std::exception& ex)
{
	zlog::LogMessage( zlog::SV_ERROR, "ZLOg", "exception: %s", ex.what() );
	std::abort();
}

BOOST_NORETURN void boost::throw_exception(const std::exception& ex, const boost::source_location&)
{
	zlog::LogMessage( zlog::SV_ERROR, "ZLOg", "exception: %s", ex.what() );
	std::abort();
}
