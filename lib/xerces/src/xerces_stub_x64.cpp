...
namespace xercesc_3_0 {
    ...
    void* XMemory::operator new(size_t size) { return ::malloc(size); }
    ...
    public:
        virtual ~DOMNodeList();
        virtual DOMNode* item(size_t) const;
        virtual size_t getLength() const;
    };

    DOMNodeList::~DOMNodeList() {}
    DOMNode* DOMNodeList::item(size_t) const { return nullptr; }
    size_t DOMNodeList::getLength() const { return 0; }
