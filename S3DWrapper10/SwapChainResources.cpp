...
void SwapChainResources::Initialize(D3DSwapChain* pSwapChain)
{
	...
	DDILog("SwapChainResources::Initialize DONE: BBLeft=%p, BBRight=%p, BBPrim=%p, RTLeft=%p, RTRight=%p, RTPrim=%p, MethodResL=%p, MethodResR=%p, AAOn=%d\n",
		m_hBackBufferLeft.pDrvPrivate, m_hBackBufferRight.pDrvPrivate, m_hBackBufferPrimary.pDrvPrivate,
		m_hBackBufferRTLeft.pDrvPrivate, m_hBackBufferRTRight.pDrvPrivate, m_hBackBufferRTPrimary.pDrvPrivate,
		m_hMethodResourceLeft.pDrvPrivate, m_hMethodResourceRight.pDrvPrivate, (int)m_bAAOn);
}
