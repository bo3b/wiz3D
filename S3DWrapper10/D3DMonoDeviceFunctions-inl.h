...
namespace MonoDeviceWrapper
{
	...
	// A2: side-table lookup replaces handle-shift cast. See
	// DeviceWrapperRegistry.h. Mono and stereo wrappers register in the same
	// side table — the cast type chosen here must match the wrapper instance
	// CreateDevice constructed (D3DMonoDeviceWrapper when UseMonoDeviceWrapper=1).
	#define D3D10_GET_MONO_WRAPPER()	((D3DMonoDeviceWrapper*)iZ3D::LookupDeviceWrapper(hDevice.pDrvPrivate))
	...
	#define DXGI_GET_MONO_WRAPPER()				((D3DMonoDeviceWrapper*)iZ3D::LookupDeviceWrapper((void*)hOrigDevice))
