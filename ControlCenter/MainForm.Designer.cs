namespace ControlCenter
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.chkbtnSimple = new Krypton.Toolkit.KryptonCheckButton();
			this.chkbtnAdvanced = new Krypton.Toolkit.KryptonCheckButton();
			this.csTabs = new Krypton.Toolkit.KryptonCheckSet(this.components);
			this.chkbtnStatus = new Krypton.Toolkit.KryptonCheckButton();
			this.chkbtnInGame = new Krypton.Toolkit.KryptonCheckButton();
			this.chkbtnExceptions = new Krypton.Toolkit.KryptonCheckButton();
			this.chkbtnUpdate = new Krypton.Toolkit.KryptonCheckButton();
			this.chkbtnSettings = new Krypton.Toolkit.KryptonCheckButton();
			this.chkbtnHelp = new Krypton.Toolkit.KryptonCheckButton();
			this.chkbtnAbout = new Krypton.Toolkit.KryptonCheckButton();
			this.csModes = new Krypton.Toolkit.KryptonCheckSet(this.components);
			this.knPages = new Krypton.Navigator.KryptonNavigator();
			this.kpStatus = new Krypton.Navigator.KryptonPage();
			this.gbOutput = new Krypton.Toolkit.KryptonGroupBox();
			this.cbOutputModes = new Krypton.Toolkit.KryptonComboBox();
			this.cbOutputs = new Krypton.Toolkit.KryptonComboBox();
			this.gbStereoStatus = new Krypton.Toolkit.KryptonGroupBox();
			this.rbDisableDriver = new Krypton.Toolkit.KryptonRadioButton();
			this.cbEnableStereoAtStartup = new Krypton.Toolkit.KryptonCheckBox();
			this.rbEnableDriver = new Krypton.Toolkit.KryptonRadioButton();
			this.kpInGame = new Krypton.Navigator.KryptonPage();
			this.knInGame = new Krypton.Navigator.KryptonNavigator();
			this.kpGame = new Krypton.Navigator.KryptonPage();
			this.lblClipping = new Krypton.Toolkit.KryptonLabel();
			this.cbSeparationMode = new Krypton.Toolkit.KryptonComboBox();
			this.lblSeparationMod = new Krypton.Toolkit.KryptonLabel();
			this.cbWindowMode = new Krypton.Toolkit.KryptonComboBox();
			this.lblWindowedMode = new Krypton.Toolkit.KryptonLabel();
			this.udSeparationScale = new Krypton.Toolkit.KryptonNumericUpDown();
			this.lblSeparationScale = new Krypton.Toolkit.KryptonLabel();
			this.udStereoSeparation = new Krypton.Toolkit.KryptonNumericUpDown();
			this.lblStereoSeparation = new Krypton.Toolkit.KryptonLabel();
			this.lblClippingWidth = new Krypton.Toolkit.KryptonLabel();
			this.tbClippingWidth = new Krypton.Toolkit.KryptonTrackBar();
			this.chkbShadowsMono = new Krypton.Toolkit.KryptonCheckBox();
			this.chkbUseSimpleStereoProjectionMethod = new Krypton.Toolkit.KryptonCheckBox();
			this.chkbForceVSyncOff = new Krypton.Toolkit.KryptonCheckBox();
			this.chkbShowOSDMessages = new Krypton.Toolkit.KryptonCheckBox();
			this.chkbEnableClipping = new Krypton.Toolkit.KryptonCheckBox();
			this.chkbShowWizard = new Krypton.Toolkit.KryptonCheckBox();
			this.chkbDisableMouseLock = new Krypton.Toolkit.KryptonCheckBox();
			this.chkbShowFPS = new Krypton.Toolkit.KryptonCheckBox();
			this.kpAutofocus = new Krypton.Navigator.KryptonPage();
			this.kryptonPanel1 = new Krypton.Toolkit.KryptonPanel();
			this.lblAutofocusBottom = new Krypton.Toolkit.KryptonLabel();
			this.lblAutofocusTop = new Krypton.Toolkit.KryptonLabel();
			this.tbTopBottom = new Krypton.Toolkit.KryptonTrackBar();
			this.udAutofocusMaxShift = new Krypton.Toolkit.KryptonNumericUpDown();
			this.udAutofocusSpeed = new Krypton.Toolkit.KryptonNumericUpDown();
			this.udAutofocusHeight = new Krypton.Toolkit.KryptonNumericUpDown();
			this.udAutofocusWidth = new Krypton.Toolkit.KryptonNumericUpDown();
			this.lblAutofocusMaximumShift = new Krypton.Toolkit.KryptonLabel();
			this.lblAutofocusSpeed = new Krypton.Toolkit.KryptonLabel();
			this.lblAutofocusHeight = new Krypton.Toolkit.KryptonLabel();
			this.lblAutofocusWidth = new Krypton.Toolkit.KryptonLabel();
			this.kpHotkeys = new Krypton.Navigator.KryptonPage();
			this.tbToggleHotkeysOSD = new Krypton.Toolkit.KryptonTextBox();
			this.lblToggleHotkeysOSD = new Krypton.Toolkit.KryptonLabel();
			this.btnRestoreDefaults = new Krypton.Toolkit.KryptonButton();
			this.tbWizard = new Krypton.Toolkit.KryptonTextBox();
			this.lblToggleWizard = new Krypton.Toolkit.KryptonLabel();
			this.tbStereoScreenshot = new Krypton.Toolkit.KryptonTextBox();
			this.lblTakeScreenshot = new Krypton.Toolkit.KryptonLabel();
			this.tbToggleLaserSight = new Krypton.Toolkit.KryptonTextBox();
			this.lblToggleLasersight = new Krypton.Toolkit.KryptonLabel();
			this.tbShowFPS = new Krypton.Toolkit.KryptonTextBox();
			this.lblToggleFPS = new Krypton.Toolkit.KryptonLabel();
			this.tbSwapLR = new Krypton.Toolkit.KryptonTextBox();
			this.lblSwapLR = new Krypton.Toolkit.KryptonLabel();
			this.tbToggleAutofocus = new Krypton.Toolkit.KryptonTextBox();
			this.lblToggleAutofocus = new Krypton.Toolkit.KryptonLabel();
			this.tbPreset3 = new Krypton.Toolkit.KryptonTextBox();
			this.lblPreset3 = new Krypton.Toolkit.KryptonLabel();
			this.tbPreset2 = new Krypton.Toolkit.KryptonTextBox();
			this.lblPreset2 = new Krypton.Toolkit.KryptonLabel();
			this.tbPreset1 = new Krypton.Toolkit.KryptonTextBox();
			this.lblPreset1 = new Krypton.Toolkit.KryptonLabel();
			this.tbToggleStereo = new Krypton.Toolkit.KryptonTextBox();
			this.lblToggleStereo = new Krypton.Toolkit.KryptonLabel();
			this.tbDecSeparation = new Krypton.Toolkit.KryptonTextBox();
			this.lblDecSep = new Krypton.Toolkit.KryptonLabel();
			this.tbIncSeparation = new Krypton.Toolkit.KryptonTextBox();
			this.lblIncSep = new Krypton.Toolkit.KryptonLabel();
			this.tbDecConvergence = new Krypton.Toolkit.KryptonTextBox();
			this.lblDecConv = new Krypton.Toolkit.KryptonLabel();
			this.tbIncConvergence = new Krypton.Toolkit.KryptonTextBox();
			this.lblIncConv = new Krypton.Toolkit.KryptonLabel();
			this.btnBrowseExe = new Krypton.Toolkit.KryptonButton();
			this.tbExeFileName = new Krypton.Toolkit.KryptonTextBox();
			this.tbProfileName = new Krypton.Toolkit.KryptonTextBox();
			this.cbProfiles = new Krypton.Toolkit.KryptonComboBox();
			this.kpUpdate = new Krypton.Navigator.KryptonPage();
			this.btnUpdate = new Krypton.Toolkit.KryptonButton();
			this.progressBar1 = new System.Windows.Forms.ProgressBar();
			this.lblUpdatesStatus = new Krypton.Toolkit.KryptonLabel();
			this.webBrowser1 = new System.Windows.Forms.WebBrowser();
			this.kpSettings = new Krypton.Navigator.KryptonPage();
			this.gbLanguage = new Krypton.Toolkit.KryptonGroupBox();
			this.cbLanguages = new Krypton.Toolkit.KryptonComboBox();
			this.gbSettings = new Krypton.Toolkit.KryptonGroupBox();
			this.chkbEnableD3D1xDriver = new Krypton.Toolkit.KryptonCheckBox();
			this.chkbLockMouse = new Krypton.Toolkit.KryptonCheckBox();
			this.chkbUpdateOnHold = new Krypton.Toolkit.KryptonCheckBox();
			this.chkbLaunchWithWindows = new Krypton.Toolkit.KryptonCheckBox();
			this.kpHelp = new Krypton.Navigator.KryptonPage();
			this.btnActivate = new Krypton.Toolkit.KryptonButton();
			this.btnSetupScreens = new Krypton.Toolkit.KryptonButton();
			this.btnTrobleshooting = new Krypton.Toolkit.KryptonButton();
			this.btnDiagnostic = new Krypton.Toolkit.KryptonButton();
			this.btnUserGuide = new Krypton.Toolkit.KryptonButton();
			this.btnStaticTest = new Krypton.Toolkit.KryptonButton();
			this.btnDynamicTest = new Krypton.Toolkit.KryptonButton();
			this.kpAbout = new Krypton.Navigator.KryptonPage();
			this.lblReleaseDate = new Krypton.Toolkit.KryptonLabel();
			this.lblVersion = new Krypton.Toolkit.KryptonLabel();
			this.lblCopyright = new Krypton.Toolkit.KryptonLabel();
			this.lblReleaseDateC = new Krypton.Toolkit.KryptonLabel();
			this.lblVersionC = new Krypton.Toolkit.KryptonLabel();
			this.kpExceptions = new Krypton.Navigator.KryptonPage();
			this.btnRemove = new Krypton.Toolkit.KryptonButton();
			this.btnAdd = new Krypton.Toolkit.KryptonButton();
			this.lbEceptionsList = new Krypton.Toolkit.KryptonListBox();
			this.tbExceptionName = new Krypton.Toolkit.KryptonTextBox();
			this.btnBrowse = new Krypton.Toolkit.KryptonButton();
			this.tbExceptionFilename = new Krypton.Toolkit.KryptonTextBox();
			...
			this.btnMinimize.OverrideFocus.Content.DrawFocus = Krypton.Toolkit.InheritBool.False;
			...
			this.btnMinimize.StateCommon.Back.ImageStyle = Krypton.Toolkit.PaletteImageStyle.CenterMiddle;
			this.btnMinimize.StateCommon.Border.Draw = Krypton.Toolkit.InheritBool.False;
			this.btnMinimize.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.None;
			...
			this.btnClose.OverrideFocus.Content.DrawFocus = Krypton.Toolkit.InheritBool.False;
			...
			this.btnClose.StateCommon.Back.ImageStyle = Krypton.Toolkit.PaletteImageStyle.CenterMiddle;
			this.btnClose.StateCommon.Border.Draw = Krypton.Toolkit.InheritBool.False;
			this.btnClose.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.None;
			...
			this.btnApply.StateCommon.Back.ImageStyle = Krypton.Toolkit.PaletteImageStyle.CenterMiddle;
			this.btnApply.StateCommon.Border.Draw = Krypton.Toolkit.InheritBool.False;
			this.btnApply.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.None;
			...
			this.chkbtnSimple.OverrideFocus.Content.DrawFocus = Krypton.Toolkit.InheritBool.False;
			this.chkbtnSimple.Size = new System.Drawing.Size(74, 21);
			this.chkbtnSimple.StateCheckedNormal.Back.Draw = Krypton.Toolkit.InheritBool.True;
			this.chkbtnSimple.StateCheckedNormal.Back.Image = global::ControlCenter.Properties.Resources.btnSimpleAdvanced_pressed;
			this.chkbtnSimple.StateCheckedTracking.Back.Draw = Krypton.Toolkit.InheritBool.True;
			this.chkbtnSimple.StateCheckedTracking.Back.Image = global::ControlCenter.Properties.Resources.btnSimpleAdvanced_pressed;
			this.chkbtnSimple.StateCommon.Back.Draw = Krypton.Toolkit.InheritBool.False;
			this.chkbtnSimple.StateCommon.Back.ImageStyle = Krypton.Toolkit.PaletteImageStyle.CenterMiddle;
			this.chkbtnSimple.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.None;
			...
			this.chkbtnAdvanced.OverrideFocus.Content.DrawFocus = Krypton.Toolkit.InheritBool.False;
			this.chkbtnAdvanced.Size = new System.Drawing.Size(74, 21);
			this.chkbtnAdvanced.StateCheckedNormal.Back.Draw = Krypton.Toolkit.InheritBool.True;
			this.chkbtnAdvanced.StateCheckedNormal.Back.Image = global::ControlCenter.Properties.Resources.btnSimpleAdvanced_pressed;
			this.chkbtnAdvanced.StateCheckedTracking.Back.Draw = Krypton.Toolkit.InheritBool.True;
			this.chkbtnAdvanced.StateCheckedTracking.Back.Image = global::ControlCenter.Properties.Resources.btnSimpleAdvanced_pressed;
			this.chkbtnAdvanced.StateCommon.Back.Draw = Krypton.Toolkit.InheritBool.False;
			this.chkbtnAdvanced.StateCommon.Back.ImageStyle = Krypton.Toolkit.PaletteImageStyle.CenterMiddle;
			this.chkbtnAdvanced.StateCommon.Border.Draw = Krypton.Toolkit.InheritBool.False;
			this.chkbtnAdvanced.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.None;
			this.chkbtnAdvanced.StateCommon.Border.Width = 0;
			this.chkbtnAdvanced.StateCommon.Content.Draw = Krypton.Toolkit.InheritBool.True;
			...
			this.chkbtnStatus.OverrideDefault.Border.Draw = Krypton.Toolkit.InheritBool.False;
			this.chkbtnStatus.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.None;
			this.chkbtnStatus.OverrideDefault.Border.Width = 0;
			this.chkbtnStatus.OverrideDefault.Content.ShortText.MultiLine = Krypton.Toolkit.InheritBool.False;
			this.chkbtnStatus.OverrideFocus.Content.DrawFocus = Krypton.Toolkit.InheritBool.False;
			...
			this.chkbtnStatus.StateCommon.Back.Draw = Krypton.Toolkit.InheritBool.True;
			this.chkbtnStatus.StateCommon.Back.Image = global::ControlCenter.Properties.Resources.btnStatus_normal;
			this.chkbtnStatus.StateCommon.Back.ImageStyle = Krypton.Toolkit.PaletteImageStyle.CenterMiddle;
			this.chkbtnStatus.StateCommon.Border.Draw = Krypton.Toolkit.InheritBool.False;
			this.chkbtnStatus.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.None;
			this.chkbtnStatus.StateCommon.Border.Width = 0;
			this.chkbtnStatus.StateCommon.Content.AdjacentGap = 10;
			this.chkbtnStatus.StateCommon.Content.Image.ImageH = Krypton.Toolkit.PaletteRelativeAlign.Near;
			...
			this.chkbtnStatus.StateCommon.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Near;
			...
			this.chkbtnInGame.OverrideDefault.Border.Draw = Krypton.Toolkit.InheritBool.False;
			this.chkbtnInGame.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.None;
			this.chkbtnInGame.OverrideDefault.Border.Width = 0;
			this.chkbtnInGame.OverrideDefault.Content.ShortText.MultiLine = Krypton.Toolkit.InheritBool.False;
			this.chkbtnInGame.OverrideFocus.Content.DrawFocus = Krypton.Toolkit.InheritBool.False;
			...
			this.chkbtnInGame.StateCommon.Back.Draw = Krypton.Toolkit.InheritBool.True;
			this.chkbtnInGame.StateCommon.Back.Image = global::ControlCenter.Properties.Resources.btnInGame_normal;
			this.chkbtnInGame.StateCommon.Back.ImageStyle = Krypton.Toolkit.PaletteImageStyle.CenterMiddle;
			this.chkbtnInGame.StateCommon.Border.Draw = Krypton.Toolkit.InheritBool.False;
			this.chkbtnInGame.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.None;
			this.chkbtnInGame.StateCommon.Border.Width = 0;
			this.chkbtnInGame.StateCommon.Content.AdjacentGap = 10;
			this.chkbtnInGame.StateCommon.Content.Image.ImageH = Krypton.Toolkit.PaletteRelativeAlign.Near;
			...
			this.chkbtnInGame.StateCommon.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Near;
			...
			this.chkbtnExceptions.OverrideDefault.Border.Draw = Krypton.Toolkit.InheritBool.False;
			this.chkbtnExceptions.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.None;
			this.chkbtnExceptions.OverrideDefault.Border.Width = 0;
			this.chkbtnExceptions.OverrideDefault.Content.ShortText.MultiLine = Krypton.Toolkit.InheritBool.False;
			this.chkbtnExceptions.OverrideFocus.Content.DrawFocus = Krypton.Toolkit.InheritBool.False;
			...
			this.chkbtnExceptions.StateCommon.Back.Draw = Krypton.Toolkit.InheritBool.True;
			this.chkbtnExceptions.StateCommon.Back.Image = global::ControlCenter.Properties.Resources.btnException_normal;
			this.chkbtnExceptions.StateCommon.Back.ImageStyle = Krypton.Toolkit.PaletteImageStyle.CenterMiddle;
			this.chkbtnExceptions.StateCommon.Border.Draw = Krypton.Toolkit.InheritBool.False;
			this.chkbtnExceptions.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.None;
			this.chkbtnExceptions.StateCommon.Border.Width = 0;
			this.chkbtnExceptions.StateCommon.Content.AdjacentGap = 10;
			this.chkbtnExceptions.StateCommon.Content.Image.ImageH = Krypton.Toolkit.PaletteRelativeAlign.Near;
			...
			this.chkbtnExceptions.StateCommon.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Near;
			...
			this.chkbtnUpdate.OverrideDefault.Border.Draw = Krypton.Toolkit.InheritBool.False;
			this.chkbtnUpdate.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.None;
			this.chkbtnUpdate.OverrideDefault.Border.Width = 0;
			this.chkbtnUpdate.OverrideDefault.Content.ShortText.MultiLine = Krypton.Toolkit.InheritBool.False;
			this.chkbtnUpdate.OverrideFocus.Content.DrawFocus = Krypton.Toolkit.InheritBool.False;
			...
			this.chkbtnUpdate.StateCommon.Back.Draw = Krypton.Toolkit.InheritBool.True;
			this.chkbtnUpdate.StateCommon.Back.Image = global::ControlCenter.Properties.Resources.btnUpdate_normal;
			this.chkbtnUpdate.StateCommon.Back.ImageStyle = Krypton.Toolkit.PaletteImageStyle.CenterMiddle;
			this.chkbtnUpdate.StateCommon.Border.Draw = Krypton.Toolkit.InheritBool.False;
			this.chkbtnUpdate.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.None;
			this.chkbtnUpdate.StateCommon.Border.Width = 0;
			this.chkbtnUpdate.StateCommon.Content.AdjacentGap = 10;
			this.chkbtnUpdate.StateCommon.Content.Image.ImageH = Krypton.Toolkit.PaletteRelativeAlign.Near;
			...
			this.chkbtnUpdate.StateCommon.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Near;
			...
			this.chkbtnSettings.OverrideDefault.Border.Draw = Krypton.Toolkit.InheritBool.False;
			this.chkbtnSettings.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.None;
			this.chkbtnSettings.OverrideDefault.Border.Width = 0;
			this.chkbtnSettings.OverrideDefault.Content.ShortText.MultiLine = Krypton.Toolkit.InheritBool.False;
			this.chkbtnSettings.OverrideFocus.Content.DrawFocus = Krypton.Toolkit.InheritBool.False;
			...
			this.chkbtnSettings.StateCommon.Back.Draw = Krypton.Toolkit.InheritBool.True;
			this.chkbtnSettings.StateCommon.Back.Image = global::ControlCenter.Properties.Resources.btnSetting_normal;
			this.chkbtnSettings.StateCommon.Back.ImageStyle = Krypton.Toolkit.PaletteImageStyle.CenterMiddle;
			this.chkbtnSettings.StateCommon.Border.Draw = Krypton.Toolkit.InheritBool.False;
			this.chkbtnSettings.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.None;
			this.chkbtnSettings.StateCommon.Border.Width = 0;
			this.chkbtnSettings.StateCommon.Content.AdjacentGap = 10;
			this.chkbtnSettings.StateCommon.Content.Image.ImageH = Krypton.Toolkit.PaletteRelativeAlign.Near;
			...
			this.chkbtnSettings.StateCommon.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Near;
			...
			this.chkbtnHelp.OverrideDefault.Border.Draw = Krypton.Toolkit.InheritBool.False;
			this.chkbtnHelp.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.None;
			this.chkbtnHelp.OverrideDefault.Border.Width = 0;
			this.chkbtnHelp.OverrideDefault.Content.ShortText.MultiLine = Krypton.Toolkit.InheritBool.False;
			this.chkbtnHelp.OverrideFocus.Content.DrawFocus = Krypton.Toolkit.InheritBool.False;
			...
			this.chkbtnHelp.StateCommon.Back.Draw = Krypton.Toolkit.InheritBool.True;
			this.chkbtnHelp.StateCommon.Back.Image = global::ControlCenter.Properties.Resources.btnHelp_normal;
			this.chkbtnHelp.StateCommon.Back.ImageStyle = Krypton.Toolkit.PaletteImageStyle.CenterMiddle;
			this.chkbtnHelp.StateCommon.Border.Draw = Krypton.Toolkit.InheritBool.False;
			this.chkbtnHelp.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.None;
			this.chkbtnHelp.StateCommon.Border.Width = 0;
			this.chkbtnHelp.StateCommon.Content.AdjacentGap = 10;
			this.chkbtnHelp.StateCommon.Content.Image.ImageH = Krypton.Toolkit.PaletteRelativeAlign.Near;
			...
			this.chkbtnHelp.StateCommon.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Near;
			...
			this.chkbtnAbout.OverrideDefault.Border.Draw = Krypton.Toolkit.InheritBool.False;
			this.chkbtnAbout.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.None;
			this.chkbtnAbout.OverrideDefault.Border.Width = 0;
			this.chkbtnAbout.OverrideDefault.Content.ShortText.MultiLine = Krypton.Toolkit.InheritBool.False;
			this.chkbtnAbout.OverrideFocus.Content.DrawFocus = Krypton.Toolkit.InheritBool.False;
			...
			this.chkbtnAbout.StateCommon.Back.Draw = Krypton.Toolkit.InheritBool.True;
			this.chkbtnAbout.StateCommon.Back.Image = global::ControlCenter.Properties.Resources.btnAbout_normal;
			this.chkbtnAbout.StateCommon.Back.ImageStyle = Krypton.Toolkit.PaletteImageStyle.CenterMiddle;
			this.chkbtnAbout.StateCommon.Border.Draw = Krypton.Toolkit.InheritBool.False;
			this.chkbtnAbout.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.None;
			this.chkbtnAbout.StateCommon.Border.Width = 0;
			this.chkbtnAbout.StateCommon.Content.AdjacentGap = 10;
			this.chkbtnAbout.StateCommon.Content.Image.ImageH = Krypton.Toolkit.PaletteRelativeAlign.Near;
			...
			this.chkbtnAbout.StateCommon.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Near;
			...
			this.knPages.NavigatorMode = Krypton.Navigator.NavigatorMode.Panel;
			this.knPages.PageBackStyle = Krypton.Toolkit.PaletteBackStyle.PanelClient;
			this.knPages.Pages.AddRange(new Krypton.Navigator.KryptonPage[] {
            this.kpStatus,
            this.kpInGame,
            this.kpUpdate,
            this.kpSettings,
			...
			this.knPages.StateCommon.Page.ImageStyle = Krypton.Toolkit.PaletteImageStyle.CenterMiddle;
			...
			this.kpStatus.StateCommon.Page.Draw = Krypton.Toolkit.InheritBool.True;
			...
			this.gbOutput.StateCommon.Back.Draw = Krypton.Toolkit.InheritBool.False;
			this.gbOutput.StateCommon.Border.Draw = Krypton.Toolkit.InheritBool.False;
			this.gbOutput.StateCommon.Border.DrawBorders = ((Krypton.Toolkit.PaletteDrawBorders)((((Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom) 
			...
			this.gbStereoStatus.StateCommon.Back.Draw = Krypton.Toolkit.InheritBool.False;
			this.gbStereoStatus.StateCommon.Border.Draw = Krypton.Toolkit.InheritBool.False;
			this.gbStereoStatus.StateCommon.Border.DrawBorders = ((Krypton.Toolkit.PaletteDrawBorders)((((Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom) 
            | Krypton.Toolkit.PaletteDrawBorders.Left) 
            | Krypton.Toolkit.PaletteDrawBorders.Right)));
			...
			// knInGame
			// 
			this.knInGame.Button.ButtonDisplayLogic = Krypton.Navigator.ButtonDisplayLogic.None;
			this.knInGame.Button.CloseButtonDisplay = Krypton.Navigator.ButtonDisplay.Hide;
			this.knInGame.Button.NextButtonDisplay = Krypton.Navigator.ButtonDisplay.Hide;
			this.knInGame.Button.PreviousButtonDisplay = Krypton.Navigator.ButtonDisplay.Hide;
			this.knInGame.Location = new System.Drawing.Point(3, 82);
			this.knInGame.Name = "knInGame";
			this.knInGame.NavigatorMode = Krypton.Navigator.NavigatorMode.BarRibbonTabGroup;
			this.knInGame.Pages.AddRange(new Krypton.Navigator.KryptonPage[] {
            this.kpGame,
            this.kpAutofocus,
            this.kpHotkeys});
			this.knInGame.SelectedIndex = 2;
			this.knInGame.Size = new System.Drawing.Size(456, 300);
			this.knInGame.StateCommon.Page.Draw = Krypton.Toolkit.InheritBool.False;
			this.knInGame.StateCommon.Panel.Draw = Krypton.Toolkit.InheritBool.False;
			this.knInGame.StateCommon.Tab.Border.Draw = Krypton.Toolkit.InheritBool.False;
			this.knInGame.StateCommon.Tab.Border.DrawBorders = ((Krypton.Toolkit.PaletteDrawBorders)((((Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom) 
            | Krypton.Toolkit.PaletteDrawBorders.Left) 
            | Krypton.Toolkit.PaletteDrawBorders.Right)));
			...
			this.kpGame.StateCommon.Page.Draw = Krypton.Toolkit.InheritBool.True;
			...
			this.kpAutofocus.StateCommon.Page.Draw = Krypton.Toolkit.InheritBool.True;
			...
			this.kpHotkeys.StateCommon.Page.Draw = Krypton.Toolkit.InheritBool.True;
			...
			this.btnRestoreDefaults.StateCommon.Back.ImageStyle = Krypton.Toolkit.PaletteImageStyle.CenterMiddle;
			this.btnRestoreDefaults.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.None;
			...
			this.btnBrowseExe.StateCommon.Back.ImageStyle = Krypton.Toolkit.PaletteImageStyle.CenterMiddle;
			this.btnBrowseExe.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.None;
			...
			this.cbProfiles.StateCommon.ComboBox.Border.DrawBorders = ((Krypton.Toolkit.PaletteDrawBorders)((((Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom) 
            | Krypton.Toolkit.PaletteDrawBorders.Left) 
            | Krypton.Toolkit.PaletteDrawBorders.Right)));
			...
			this.btnUpdate.StateCommon.Back.ImageStyle = Krypton.Toolkit.PaletteImageStyle.CenterMiddle;
			this.btnUpdate.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.None;
			...
			this.gbLanguage.StateCommon.Back.Draw = Krypton.Toolkit.InheritBool.False;
			this.gbLanguage.StateCommon.Border.Draw = Krypton.Toolkit.InheritBool.False;
			this.gbLanguage.StateCommon.Border.DrawBorders = ((Krypton.Toolkit.PaletteDrawBorders)((((Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom) 
            | Krypton.Toolkit.PaletteDrawBorders.Left) 
            | Krypton.Toolkit.PaletteDrawBorders.Right)));
			...
			this.gbSettings.StateCommon.Back.Draw = Krypton.Toolkit.InheritBool.False;
			this.gbSettings.StateCommon.Border.Draw = Krypton.Toolkit.InheritBool.False;
			this.gbSettings.StateCommon.Border.DrawBorders = ((Krypton.Toolkit.PaletteDrawBorders)((((Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom) 
            | Krypton.Toolkit.PaletteDrawBorders.Left) 
            | Krypton.Toolkit.PaletteDrawBorders.Right)));
			...
			this.btnSetupScreens.StateCommon.Back.ImageStyle = Krypton.Toolkit.PaletteImageStyle.CenterMiddle;
			...
			this.btnSetupScreens.StateDisabled.Back.ImageStyle = Krypton.Toolkit.PaletteImageStyle.CenterMiddle;
			this.btnSetupScreens.StateDisabled.Border.Draw = Krypton.Toolkit.InheritBool.False;
			this.btnSetupScreens.StateDisabled.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.None;
			...
			this.btnRemove.StateCommon.Back.ImageStyle = Krypton.Toolkit.PaletteImageStyle.CenterMiddle;
			this.btnRemove.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.None;
			...
			this.btnAdd.StateCommon.Back.ImageStyle = Krypton.Toolkit.PaletteImageStyle.CenterMiddle;
			this.btnAdd.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.None;
			...
			this.lbEceptionsList.StateCommon.Border.Draw = Krypton.Toolkit.InheritBool.False;
			this.lbEceptionsList.StateCommon.Border.DrawBorders = ((Krypton.Toolkit.PaletteDrawBorders)((((Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom) 
            | Krypton.Toolkit.PaletteDrawBorders.Left) 
            | Krypton.Toolkit.PaletteDrawBorders.Right)));
			...
			this.btnBrowse.StateCommon.Back.ImageStyle = Krypton.Toolkit.PaletteImageStyle.CenterMiddle;
			this.btnBrowse.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.None;
			...
			// kryptonManager1
			// 
			this.kryptonManager1.GlobalCustomPalette = this.kryptonPalette1;
			this.kryptonManager1.GlobalPaletteMode = Krypton.Toolkit.PaletteMode.Custom;
			// 
			// kryptonPalette1
			// 
			this.kryptonPalette1.BasePaletteType = Krypton.Toolkit.BasePaletteType.Sparkle;
        ...
        private Krypton.Toolkit.KryptonCheckButton chkbtnSimple;
        private Krypton.Toolkit.KryptonCheckButton chkbtnAdvanced;
		private Krypton.Toolkit.KryptonCheckSet csTabs;
		private Krypton.Toolkit.KryptonCheckButton chkbtnStatus;
		private Krypton.Toolkit.KryptonCheckButton chkbtnInGame;
		private Krypton.Toolkit.KryptonCheckButton chkbtnExceptions;
		private Krypton.Toolkit.KryptonCheckButton chkbtnUpdate;
		private Krypton.Toolkit.KryptonCheckButton chkbtnSettings;
		private Krypton.Toolkit.KryptonCheckButton chkbtnHelp;
		private Krypton.Toolkit.KryptonCheckButton chkbtnAbout;
		private Krypton.Toolkit.KryptonCheckSet csModes;
        private Krypton.Navigator.KryptonNavigator knPages;
        private Krypton.Navigator.KryptonPage kpStatus;
        private Krypton.Navigator.KryptonPage kpInGame;
        private Krypton.Navigator.KryptonPage kpUpdate;
        private Krypton.Navigator.KryptonPage kpSettings;
        private Krypton.Navigator.KryptonPage kpHelp;
        private Krypton.Navigator.KryptonPage kpAbout;
        private Krypton.Navigator.KryptonNavigator knInGame;
        private Krypton.Navigator.KryptonPage kpGame;
        private Krypton.Navigator.KryptonPage kpAutofocus;
        private Krypton.Navigator.KryptonPage kpHotkeys;
        private Krypton.Toolkit.KryptonButton btnBrowseExe;
		private Krypton.Toolkit.KryptonTextBox tbExeFileName;
        private Krypton.Toolkit.KryptonComboBox cbProfiles;
        private Krypton.Toolkit.KryptonGroupBox gbLanguage;
        private Krypton.Toolkit.KryptonGroupBox gbSettings;
        private Krypton.Toolkit.KryptonButton btnSetupScreens;
        private Krypton.Toolkit.KryptonButton btnTrobleshooting;
        private Krypton.Toolkit.KryptonButton btnDiagnostic;
        private Krypton.Toolkit.KryptonButton btnUserGuide;
        private Krypton.Toolkit.KryptonButton btnStaticTest;
        private Krypton.Toolkit.KryptonButton btnDynamicTest;
        private Krypton.Navigator.KryptonPage kpExceptions;
        private Krypton.Toolkit.KryptonGroupBox gbOutput;
        private Krypton.Toolkit.KryptonComboBox cbOutputModes;
        private Krypton.Toolkit.KryptonComboBox cbOutputs;
        private Krypton.Toolkit.KryptonGroupBox gbStereoStatus;
        private Krypton.Toolkit.KryptonRadioButton rbDisableDriver;
        private Krypton.Toolkit.KryptonCheckBox cbEnableStereoAtStartup;
        private Krypton.Toolkit.KryptonRadioButton rbEnableDriver;
        private Krypton.Toolkit.KryptonButton btnUpdate;
        private System.Windows.Forms.ProgressBar progressBar1;
        private Krypton.Toolkit.KryptonLabel lblUpdatesStatus;
        private System.Windows.Forms.WebBrowser webBrowser1;
        private Krypton.Toolkit.KryptonButton btnRemove;
        private Krypton.Toolkit.KryptonButton btnAdd;
        private Krypton.Toolkit.KryptonListBox lbEceptionsList;
        private Krypton.Toolkit.KryptonTextBox tbExceptionName;
        private Krypton.Toolkit.KryptonButton btnBrowse;
        private Krypton.Toolkit.KryptonTextBox tbExceptionFilename;
        private Krypton.Toolkit.KryptonComboBox cbLanguages;
        private Krypton.Toolkit.KryptonCheckBox chkbEnableD3D1xDriver;
        private Krypton.Toolkit.KryptonCheckBox chkbLockMouse;
        private Krypton.Toolkit.KryptonCheckBox chkbUpdateOnHold;
        private Krypton.Toolkit.KryptonCheckBox chkbLaunchWithWindows;
        ...
        private Krypton.Toolkit.KryptonLabel lblReleaseDateC;
        private Krypton.Toolkit.KryptonLabel lblVersionC;
        private Krypton.Toolkit.KryptonComboBox cbSeparationMode;
        private Krypton.Toolkit.KryptonLabel lblSeparationMod;
        private Krypton.Toolkit.KryptonComboBox cbWindowMode;
        private Krypton.Toolkit.KryptonLabel lblWindowedMode;
		private Krypton.Toolkit.KryptonNumericUpDown udSeparationScale;
        private Krypton.Toolkit.KryptonLabel lblSeparationScale;
		private Krypton.Toolkit.KryptonNumericUpDown udStereoSeparation;
        private Krypton.Toolkit.KryptonLabel lblStereoSeparation;
        private Krypton.Toolkit.KryptonLabel lblClippingWidth;
        private Krypton.Toolkit.KryptonTrackBar tbClippingWidth;
        private Krypton.Toolkit.KryptonCheckBox chkbShadowsMono;
        private Krypton.Toolkit.KryptonCheckBox chkbUseSimpleStereoProjectionMethod;
        private Krypton.Toolkit.KryptonCheckBox chkbForceVSyncOff;
        private Krypton.Toolkit.KryptonCheckBox chkbShowOSDMessages;
        private Krypton.Toolkit.KryptonCheckBox chkbEnableClipping;
        private Krypton.Toolkit.KryptonCheckBox chkbShowWizard;
        private Krypton.Toolkit.KryptonCheckBox chkbDisableMouseLock;
        private Krypton.Toolkit.KryptonCheckBox chkbShowFPS;
        private Krypton.Toolkit.KryptonButton btnRestoreDefaults;
        private Krypton.Toolkit.KryptonTextBox tbWizard;
        private Krypton.Toolkit.KryptonLabel lblToggleWizard;
        private Krypton.Toolkit.KryptonTextBox tbStereoScreenshot;
        private Krypton.Toolkit.KryptonLabel lblTakeScreenshot;
        private Krypton.Toolkit.KryptonTextBox tbToggleLaserSight;
        private Krypton.Toolkit.KryptonLabel lblToggleLasersight;
        private Krypton.Toolkit.KryptonTextBox tbShowFPS;
        private Krypton.Toolkit.KryptonLabel lblToggleFPS;
        private Krypton.Toolkit.KryptonTextBox tbSwapLR;
        private Krypton.Toolkit.KryptonLabel lblSwapLR;
        private Krypton.Toolkit.KryptonTextBox tbToggleAutofocus;
        private Krypton.Toolkit.KryptonLabel lblToggleAutofocus;
        private Krypton.Toolkit.KryptonTextBox tbPreset3;
        private Krypton.Toolkit.KryptonLabel lblPreset3;
        private Krypton.Toolkit.KryptonTextBox tbPreset2;
        private Krypton.Toolkit.KryptonLabel lblPreset2;
        private Krypton.Toolkit.KryptonTextBox tbPreset1;
        private Krypton.Toolkit.KryptonLabel lblPreset1;
        private Krypton.Toolkit.KryptonTextBox tbToggleStereo;
        private Krypton.Toolkit.KryptonLabel lblToggleStereo;
        private Krypton.Toolkit.KryptonTextBox tbDecSeparation;
        private Krypton.Toolkit.KryptonLabel lblDecSep;
        private Krypton.Toolkit.KryptonTextBox tbIncSeparation;
        private Krypton.Toolkit.KryptonLabel lblIncSep;
        private Krypton.Toolkit.KryptonTextBox tbDecConvergence;
        private Krypton.Toolkit.KryptonLabel lblDecConv;
        private Krypton.Toolkit.KryptonTextBox tbIncConvergence;
        private Krypton.Toolkit.KryptonLabel lblIncConv;
        private Krypton.Toolkit.KryptonPanel kryptonPanel1;
        private Krypton.Toolkit.KryptonLabel lblAutofocusBottom;
        private Krypton.Toolkit.KryptonLabel lblAutofocusTop;
        private Krypton.Toolkit.KryptonTrackBar tbTopBottom;
		private Krypton.Toolkit.KryptonNumericUpDown udAutofocusMaxShift;
        private Krypton.Toolkit.KryptonNumericUpDown udAutofocusSpeed;
        private Krypton.Toolkit.KryptonNumericUpDown udAutofocusHeight;
        private Krypton.Toolkit.KryptonNumericUpDown udAutofocusWidth;
        private Krypton.Toolkit.KryptonLabel lblAutofocusMaximumShift;
        private Krypton.Toolkit.KryptonLabel lblAutofocusSpeed;
        private Krypton.Toolkit.KryptonLabel lblAutofocusHeight;
        private Krypton.Toolkit.KryptonLabel lblAutofocusWidth;
		...
		private Krypton.Toolkit.KryptonLabel lblReleaseDate;
		private Krypton.Toolkit.KryptonTextBox tbProfileName;
		private System.Windows.Forms.OpenFileDialog openFileDialog;
		private Krypton.Toolkit.KryptonLabel lblClipping;
		private Krypton.Toolkit.KryptonButton btnActivate;
		private Krypton.Toolkit.KryptonTextBox tbToggleHotkeysOSD;
		private Krypton.Toolkit.KryptonLabel lblToggleHotkeysOSD;
