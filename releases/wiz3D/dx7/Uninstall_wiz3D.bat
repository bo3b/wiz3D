@echo off
echo ============================================
echo  Wiz3D Uninstaller - DX7 (DDraw)
echo ============================================
echo.
...
if exist "ddraw.dll" del /f /q "ddraw.dll"
if exist "d3d9.dll" del /f /q "d3d9.dll"
if exist "S3DWrapperD3D7.dll" del /f /q "S3DWrapperD3D7.dll"
...
if exist "wiz3D_ddraw_proxy.log" del /f /q "wiz3D_ddraw_proxy.log"
